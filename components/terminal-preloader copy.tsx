    ...
    <div className="preloader-container fixed inset-0 z-[9999] bg-black flex items-center justify-center">
      ...
      <div className="center-text text-center space-y-8">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/4 left-1/4 text-orange-500/30 text-2xl animate-bounce font-mono">
            &lt;/&gt;
          </div>
          <div className="absolute top-3/4 right-1/4 text-orange-500/30 text-2xl animate-pulse font-mono">{`{}`}</div>
          <div className="absolute top-1/2 left-1/6 text-orange-500/30 text-xl animate-bounce delay-300 font-mono">
            ( )
          </div>
          <div className="absolute bottom-1/4 right-1/6 text-orange-500/30 text-xl animate-pulse delay-500 font-mono">
            [ ]
          </div>
        </div>
      </div>
